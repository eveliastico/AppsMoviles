...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageResId = intent.getIntExtra("IMAGE_RES_ID", R.drawable.colddrinks)
        imageView.setImageResource(imageResId)

        val productType = intent.getStringExtra("PRODUCT_TYPE") ?: "coldDrinks"

        // Inicializar la lista correcta de productos
        val productos = when (productType) {
            "hotDrinks" -> {
                agregaHotDrinks()
                hotDrinks
            }
